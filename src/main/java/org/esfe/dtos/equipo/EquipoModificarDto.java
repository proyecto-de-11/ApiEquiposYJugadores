...
@Getter
@Setter
public class EquipoModificarDto implements Serializable {

    @NotNull(message = "El ID es obligatorio para la modificación.")
    ...
    @Size(max = 250, message = "La ciudad no puede exceder los 250 caracteres.")
